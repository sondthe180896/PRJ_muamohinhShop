                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Scale</label>
                                    <input value="${detail.scale}" name="scale" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input value="${Math.round(detail.price)}" name="price" type="number" step="1" min="0" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Stock</label>
                                    <input value="${detail.stock}" name="stock" type="number" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Title</label>
