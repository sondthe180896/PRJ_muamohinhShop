...
public class ProductByBrand extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // In ra giá trị của brand để kiểm tra
        System.out.println("Brand selected: " + brand);

        ProductDAO productDAO = new ProductDAO();
        List<Product> productList = productDAO.getAllProductByBrand(brand);
        ...
        request.setAttribute("brand", brand); // Truyền brand vào để highlight trên UI nếu cần
