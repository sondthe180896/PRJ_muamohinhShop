...
public class EditControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String pbrand = request.getParameter("brand");  // Added brand
        String pscale = request.getParameter("scale");  // Added scale
        String stock = request.getParameter("stock");
        int pstock = Integer.parseInt(stock);
        ProductDAO dao = new ProductDAO();
        dao.editProduct(pid, pname, pbrand, pscale, pprice, pstock , pdescription, pimage, ptitle, pcategory);
